      ...
      <Card className="main-card">
        ...
        <Card.Body>
          <Table striped bordered hover variant="dark">
            ...
            <tbody>
              <CreditCardRows creditCards={creditCards} onDeleteClick={(onDeleteClick)} />
            </tbody>
          </Table>
...
function CreditCardRow({ rowData, onDeleteClick }) {
  return (
    <tr>
      <td>
      ...
      <td>{rowData.No}</td>
      <td>{rowData.CreditCardStatusId}</td>
      <td>{rowData.CreditCardProviderId}</td>
    </tr>
  )
}

function CreditCardRows({ creditCards, onDeleteClick }) {
  return creditCards.map(t => <CreditCardRow key={t.Id} rowData={t} onDeleteClick={onDeleteClick} />);
}